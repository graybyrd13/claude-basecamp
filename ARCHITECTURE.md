...
- `lib/recall.js` — **Recall**: incremental inverted index over every transcript (mtime-swept, persisted to `recall-index.json`, AND queries with trailing-prefix typeahead, on-demand snippets). Feeds the cmd-K palette
